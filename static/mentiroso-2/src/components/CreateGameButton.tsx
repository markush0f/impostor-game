...
const CreateGameButton: React.FC = () => {
    ...
    return (
        <button
            onClick={handleClick}
            className="group relative w-full py-4 rounded-2xl font-black text-xl 
      bg-gradient-to-br from-emerald-500 via-green-600 to-teal-600 text-white 
      shadow-2xl shadow-green-900/50 hover:shadow-emerald-500/60 
      ...
      overflow-hidden border-2 border-white/20"
        >
            ...
            <span className="relative flex items-center justify-center gap-3">
                ...
                <span className="tracking-wide">CREAR PARTIDA</span>
